      ...
      <div className="max-w-4xl mx-auto space-y-5">
        ...
        <div className="bg-white rounded-3xl p-4 sm:p-6 border border-sky-100 shadow-xs space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-sky-50">
            ...
            <div className="flex items-center gap-1.5 flex-wrap self-end sm:self-auto">
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-emerald-50 hover:bg-emerald-100 text-emerald-700 border border-emerald-200 text-xs font-bold transition-colors cursor-pointer shadow-2xs"
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-sky-50 hover:bg-sky-100 text-sky-800 border border-sky-200 text-xs font-bold transition-colors cursor-pointer shadow-2xs"
              ...
              {!isDeleted ? (
                <button
                  ...
                  className="p-1.5 rounded-xl bg-rose-50 hover:bg-rose-100 text-rose-600 border border-rose-200 text-xs transition-colors cursor-pointer shadow-2xs"
                ...
                <button
                  onClick={() => onRestorePatient(patient.id)}
                  className="p-1.5 rounded-xl bg-emerald-50 hover:bg-emerald-100 text-emerald-700 border border-emerald-200 text-xs transition-colors cursor-pointer shadow-2xs"
          ...
          <div className="pt-2 border-t border-sky-100">
            ...
            {/* Container: If width permits, appears on the SAME line. On narrow mobile phones, listed below one another */}
            <nav
              className="flex flex-col md:flex-row md:items-center gap-2 p-1.5 bg-slate-50/80 rounded-2xl border border-sky-100/80 shadow-2xs"
            ...
            >
              ...
              <button
                ...
                className={`w-full md:flex-1 p-2.5 sm:px-3 sm:py-2.5 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center justify-between gap-2 border relative overflow-hidden group ${
              ...
              {/* Arrow Indicator: Right on desktop/tablet, Down on mobile phone */}
              <div className="flex items-center justify-center shrink-0 text-sky-400">
                <ArrowRight className="hidden md:block w-4 h-4" />
                <ArrowDown className="block md:hidden w-3.5 h-3.5 text-sky-300" />
              </div>
              ...
              <div className="flex items-center justify-center shrink-0 text-indigo-400">
                <ArrowRight className="hidden md:block w-4 h-4" />
                <ArrowDown className="block md:hidden w-3.5 h-3.5 text-indigo-300" />
              </div>
        ...
        {activeSubTab === 'diagnosis' && (
          <div className="space-y-5">
            ...
            <div className="p-4 bg-indigo-50/85 border border-indigo-200 rounded-3xl flex flex-col sm:flex-row items-center justify-between gap-3 shadow-2xs">
              <div className="flex items-center gap-2.5">
                <Sparkles className="w-5 h-5 text-indigo-600 shrink-0" />
                <div>
                  <h4 className="text-xs font-extrabold text-indigo-950">Done with Assessment & Demographics?</h4>
                  <p className="text-[11px] text-indigo-800">Proceed to Step 2 to configure treatment modalities and consultation fees.</p>
                </div>
              </div>
              <button
                type="button"
                onClick={() => setActiveSubTab('modalities')}
                className="w-full sm:w-auto px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-xs font-bold shadow-xs transition-all flex items-center justify-center gap-2 cursor-pointer shrink-0"
              >
              ...
              <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
                  <button
                    ...
                    disabled={isDeleted}
                    className={`flex items-center gap-2 p-2.5 rounded-xl border text-xs font-semibold transition-colors cursor-pointer ${
                  ...
                  >
                    ...
                    >
                      {patient.comorbid?.diabetes && <Check className="w-3 h-3" />}
                    </div>
                  ...
                  >
                    ...
                    >
                      {patient.comorbid?.bp && <Check className="w-3 h-3" />}
                    </div>
                  ...
                  >
                    ...
                    >
                      {patient.comorbid?.thyroid && <Check className="w-3 h-3" />}
                    </div>
                  ...
                  >
                    ...
                    >
                      {patient.comorbid?.other && <Check className="w-3 h-3" />}
                    </div>
        ...
        {activeSubTab === 'modalities' && (
          <div className="space-y-5">
            ...
            <div className="p-4 bg-emerald-50 border border-emerald-200 rounded-3xl flex flex-col sm:flex-row items-center justify-between gap-3 shadow-2xs">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-emerald-800">Log recurring treatment visits, pain progression (VAS scores), and follow-up fee receipts.</p>
                </div>
              </div>
              <button
                type="button"
                onClick={() => setActiveSubTab('followups')}
                className="w-full sm:w-auto px-4 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-bold shadow-xs transition-all flex items-center justify-center gap-2 cursor-pointer shrink-0"
              >
        ...
        {activeSubTab === 'followups' && (
          <div className="space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white rounded-3xl p-4 sm:p-5 border border-sky-100 shadow-xs">
              <div>
                <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                <button
                  type="button"
                  onClick={() => setShowPainModal(true)}
                  className="flex items-center gap-1.5 px-3 py-2 bg-sky-50 hover:bg-sky-100 text-sky-800 rounded-xl text-xs font-bold border border-sky-200 transition-colors cursor-pointer shadow-2xs"
                  title="View full pain recovery trajectory and chart"
                >
                  <TrendingDown className="w-3.5 h-3.5 text-sky-600" />
                ...
                <button
                  ...
                  disabled={isDeleted}
                  className="flex items-center gap-1.5 px-4 py-2 bg-sky-600 hover:bg-sky-700 text-white rounded-xl text-xs font-bold shadow-xs transition-colors cursor-pointer disabled:opacity-50"
                >
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="pt-2 border-t border-sky-50 space-y-3 bg-sky-50/40 p-3 rounded-2xl border border-sky-100/60">
                        ...
                        {fuAfter !== undefined && (
                          <div className="flex items-center justify-between text-[11px] pt-1.5 border-t border-sky-100">
                            <span className="font-semibold text-slate-600">Session Pain Relief:</span>
                            <span
