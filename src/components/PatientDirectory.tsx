      ...
      <div className="p-3 sm:p-4 border-b border-sky-100 space-y-2.5 bg-sky-50/40">
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          {closeHandler && (isMobileOpen === undefined || isMobileOpen === true) && (
            <button
              ...
              className="py-1 px-2.5 rounded-xl bg-red-600 hover:bg-red-700 active:bg-red-800 text-white text-xs font-bold shadow-xs transition-colors cursor-pointer whitespace-nowrap flex items-center gap-1 shrink-0"
        ...
        <div className="flex items-center gap-1.5 flex-wrap sm:flex-nowrap">
          ...
          <button
            ...
            className="flex-1 py-1.5 px-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold shadow-xs transition-colors cursor-pointer whitespace-nowrap text-center min-w-[90px]"
            title="Add Patient"
          >
            Add Patient
          </button>
          ...
          <button
            ...
            className={`py-1.5 px-2.5 rounded-xl text-xs font-bold shadow-xs transition-colors cursor-pointer whitespace-nowrap flex items-center justify-center gap-1 border ${
          ...
          <button
            ...
            className="py-1.5 px-2.5 rounded-xl bg-emerald-50 hover:bg-emerald-100 text-emerald-800 border border-emerald-200 text-xs font-bold shadow-2xs transition-colors cursor-pointer whitespace-nowrap flex items-center justify-center gap-1"
